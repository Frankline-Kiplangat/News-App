...
def process_sources_results(sources_list):
    ...
    for source_item in sources_list:
        ...
        # if poster:
        source_object = Sources(id, title, description, url, newsCategory, language, country)
...
def process_articles_results(articles_list):
    ...
    for article_item in articles_list:
        ...
        publishedOn = article_item.get('publishedOn')
        content = article_item.get('content')

        if urlToImage:
            article_object = Articles(id, title, author, description, url, urlToImage, publishedOn, content)
